...
export const Hero: React.FC<HeroProps> = ({ onOpenBooking }) => {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-zinc-950 text-white min-h-[100dvh] sm:min-h-[640px] lg:min-h-[720px] flex items-center justify-center">
        ...
        <div className="my-auto py-2 sm:py-6 max-w-4xl mx-auto w-full text-center space-y-6 sm:space-y-5 flex flex-col items-center">
          ...
          <div className="w-full max-w-sm mx-auto pt-2 sm:hidden">
            <div className="grid grid-cols-2 gap-3.5">
              ...
              {/* Button 3: Por un día */}
              <button
                onClick={() => scrollToSection('por-un-dia')}
      ...
      {/* ALWAYS VISIBLE GLOBAL / FLOATING WHATSAPP BUTTON (Mobile & Desktop) */}
      <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50">
        ...
        >
          ...
          <div className="relative w-16 h-16 sm:w-24 sm:h-24 flex items-center justify-center">
            ...
            <div className="w-11 h-11 sm:w-13 sm:h-13 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-[0_0_20px_rgba(37,211,102,0.7)] border-2 border-white group-hover:bg-[#1EB8BF] transition-all duration-300">
