        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              <img src="/marca_el_galpon_blanca.svg" alt="El Galpón" className="h-12 w-auto max-w-[200px] object-contain" />
            </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2.5 text-xs font-black">
              ...
              <li>
                <button onClick={onOpenVirtualCard} className="hover:text-[#ED3078] transition-colors flex items-center gap-1.5 text-[#ED3078] uppercase cursor-pointer">
                  <Heart className="w-3.5 h-3.5 text-[#ED3078] fill-[#ED3078]" />
                  <span>Simulador Tarjeta Virtual RSVP</span>
                </button>
              </li>
            </ul>
          </div>
