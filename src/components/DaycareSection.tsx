...
export const DaycareSection: React.FC = () => {
  return (
    <section id="por-un-dia" className="w-full bg-gradient-to-b from-[#A3BA13] via-[#A3BA13] via-45% to-[#F2C700] text-black py-16 sm:py-24 transition-colors">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-5">
              ...
              <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-black text-white leading-tight">
                Por Un Día, <span className="text-[#F2C700] drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)]">Algo Increíble</span>
              </h2>
              ...
              <div className="pt-2">
                <a
                  href={`${BRAND_INFO.whatsappUrl}?text=${encodeURIComponent('Hola! Quisiera consultar disponibilidad y tarifas para el Pase Por Un Día / Cuidado Diario en El Galpón.')}`}
                  target="_blank"
                ...
                >
                  ...
                  <span>Reservar Pase "Por Un Día"</span>
                </a>
              </div>
