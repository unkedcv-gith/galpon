...
const GALLERY_IMAGES: GalleryImage[] = [
  {
    id: 'galpon_1',
    src: '/actividades_galpon1.webp',
    title: 'Muro de Escalada & Boulder',
    category: 'Escalada',
  },
  {
    id: 'galpon_2',
    src: '/actividades_galpon2.webp',
    title: 'Tirolesa de Vuelo Asistida',
    category: 'Aventura',
  },
  {
    id: 'galpon_3',
    src: '/actividades_galpon3.webp',
    title: 'Circuitos y Destreza Física',
    category: 'Circuitos',
  },
  {
    id: 'galpon_4',
    src: '/actividades_galpon4.webp',
    title: 'Camas Elásticas y Saltos',
    category: 'Acrobacia',
  },
  {
    id: 'galpon_5',
    src: '/actividades_galpon5.webp',
    title: 'Telas y Aros Suspendidos',
    category: 'Telas',
  },
  {
    id: 'galpon_6',
    src: '/actividades_galpon6.jpg',
